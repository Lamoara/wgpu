...
bitflags_array! {
    ...
    pub struct FeaturesWGPU features_wgpu {
        ...
        ///
        /// This is a native only feature.
        const GLES_SHADER_PASSTHROUGH = 1 << 26;
        /// Enables multiview render passes and `builtin(view_index)` in vertex shaders.
        ///
        /// Supported platforms:
        /// - Vulkan
        ...
        ///
        /// This is a native only feature.
        const VERTEX_ATTRIBUTE_64BIT = 1 << 28;
        ...
        const TEXTURE_FORMAT_NV12 = 1 << 30;
        ...
        ///
        /// This is a native-only feature.
        const EXPERIMENTAL_RAY_TRACING_ACCELERATION_STRUCTURE = 1 << 31;
